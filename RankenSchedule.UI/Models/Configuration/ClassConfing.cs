...
{
    public class ClassConfing : IEntityTypeConfiguration<Class>
    {
        public void Configure(EntityTypeBuilder<Class> entity)
        {
            ...
            entity.HasData(
                ...
                new Class { ClassId = 7, Title = "Intro to IT Administrator", Number = 106, TeacherId = 4, DayId = 1, MilitaryTime = "0800" },
